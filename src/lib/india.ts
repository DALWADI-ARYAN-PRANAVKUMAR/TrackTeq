...
export const STATE_CODE: Record<string, string> = {
  ...
  TN: "Tamil Nadu", TS: "Telangana", UP: "Uttar Pradesh", UK: "Uttarakhand",
  WB: "West Bengal",
};

export interface City { name: string; state: string; lon: number; lat: number; }
...
export const INDIAN_CITIES: City[] = [
  ...
  { name: "Delhi",        state: "Delhi",          lon: 77.10, lat: 28.70 },
